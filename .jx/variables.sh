...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-release-version/HEAD/4'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-release-version:2.9.5'
