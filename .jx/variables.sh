...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-release-version/main/18'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-release-version:2.8.2'
