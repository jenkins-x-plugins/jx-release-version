...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-plugins/jx-release-version/main/7'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-release-version:2.4.13'
