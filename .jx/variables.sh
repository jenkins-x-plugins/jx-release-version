...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-release-version/main/11'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-release-version:2.7.8'
